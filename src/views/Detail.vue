<template>
  <div class="page sub">
    <Navbar v-if="style == '1'" @getUrl="getUrl"></Navbar>
    ...
    <div class="section">
      <div class="mid small">
        <div class="router">
          ...
          <a @click="listShow(content.newtypetext)">{{ nametitle }}</a>
        ...
        <div class="row1 row" >
          ...
          <div class="col v-t sidebarleft30">
            <div class="panel" v-show="content">
              <div class="panel-tit">
                <h2 class="title">
                  <span class="active">{{ content.newtypetext }}</span>
                </h2>
              </div>
              <div class="panel-info">
                <div class="detail">
...
export default {
  ...
  methods:{
    ...
    listShow(name,showname){
      let setDate =JSON.parse(localStorage.getItem('setDate'))
      this.$router.push({path: '/infos',query:{id:this.queryId,newtypetext:this.content.newtypetext,ywname:name,index:this.$route.query.index,nameCode:setDate.nameCode,nametitle:this.nametitle}})
    }
  },
