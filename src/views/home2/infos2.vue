<template>
    <div class="page sub2 page2">
        ...
        <div class="row sub-tit">
          ...
          <div class="col v-m t-r">
            <div class="search small small2" style="margin-bottom: 70px;">
              ...
              />
              <router-link :to="'/search2?keyword=' + params.keyword"
          ...
          <div class="row row1">
            <div class="col v-t sidebarleft" v-if="ifhavesirst">
              <div  style="margin-right: 42px">
                ...
                <li v-for="(item, index) in list2" :key="index" class="new dot1 images-title">
                  <router-link to="/sub/detail2">{{item.title}}</router-link>
            ...
            <div class="col v-t sidebarleft30">
              <div class="panel">
                <div class="panel-tit">
                  <h2 class="title">
                    <span class="active2">{{ newtypetext }}</span>
                  </h2>
                </div>
                <div class="panel-info">
            ...
            <div>
      <div class="panel">
        <div class="panel-tit"><h2 class="title"><span class="active2">内部公告</span></h2><a  class="panel-more"></a></div>
        <div class="panel-info">
          <ul class="list large">
      ...
      <div class="panel">
        <div class="panel-tit"><h2 class="title"><span class="active2">对区院通知公告</span></h2><a  class="panel-more"></a></div>
        <div class="panel-info">
          <ul class="list large">
            <li v-for="(item, index) in list1" :key="index" class="new dot2"><a >{{item.title}}</a><span>{{item.time}}</span></li>
          </ul>
  ...
  export default {
    ...
    created(){
      ...
      if(this.$route && this.$route.query &&this.$route.query.nameCode){
              this.name=this.$route.query.nameCode
            }
    ...
    methods :{
      ...
      getPageDate(){ 
        ...
        self.$http.post('zyWebRest_getMenuCategoryByParentid', {'parentid':self.lmId}).then(res2 => {
          if(res2){
            ...
            if(self.$route.query.clickshowname){
              self.newtypetext = self.$route.query.clickshowname;
            }else{
      ...
      goDetail(item){
        ...
        if(item.flag == 1){
          this.$router.push({path: `/detail2?index=${index}&flag=${item.flag}&id=${item.id}`})
        }else{
          this.$router.push({path: `/detail2?index=${index}&id=${item.id}&firstlmName=${this.firstlmName}`})
        }
